  ...
  <q-page class="q-pa-md q-gutter-md">
    <m-loading ref="main">
      <div class="row items-center q-my-md q-gutter-md justify-end">
        ...
        <q-btn
          v-if="is_revisor"
          @click="dl = { show: true, info: info.info, status: info.status }"
          unelevated
          color="primary"
          label="Revisar"
        />
        <q-btn
          ...
          label="Editar"
          icon="edit"
          :to="`/postulante/editar/${$route.params.id}`"
        />
      </div>
      ...
      <div>
        <table class="table-exp">
          <tbody>
            <tr :key="index" v-for="(el, index) in experiencia">
