    ...
    <m-loading ref="main">
      ...
      >
        ...
        <q-input
          ...
          :rules="[
            (val) =>
              (val && val.trim().match(/[0-9]{8}/)) || 'Por favor ingrese dni'
          ]"
        />
      </div>
      <div
      ...
      >
        ...
        <q-input
          ...
          class="t-text-2xl t-w-full"
          outlined
          :label="$q.screen.lt.sm ? 'Fecha del dato' : undefined"
          v-model="fecha"
          mask="date"
          fill-mask="_"
          :rules="['date']"
...
export default {
  ...
  methods: {
    ...
    registro() {
      ...
      // const error =
      //   this.$refs.rdni.hasError ||
      //   this.$refs.rtligero.hasError ||
      //   this.$refs.rtprofundo.hasError ||
      //   this.$refs.rtrem.hasError
      // if (error) {
      //   alert('Corregir')
      //   return
      // } else {
