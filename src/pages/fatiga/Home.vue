	...
	<q-page class="t-flex t-flex-col t-justify-between">
		...
		<m-loading ref="main" class="t-flex-1 t-flex t-items-center t-justify-center t-flex-col">
			<div class="t-w-full t-text-center">
				<div class="t-text-lg t-p-6 t-font-bold t-text-gray-600">Para poder registrarte, ingresa tu dni y haz click en el boton</div>
				...
				<div class="t-my-4">
					<button v-if="isok" type="button" class="login-with-google-btn" @click="open_login">
					  Login con Google
					</button>
	...
	function open_login() {
		main.value.get('/fatiga/login_google',b=>{
			if (b.op=='redirect') {
				...
				console.warn('Respuesta desconocida:',new String(b.op))
			}
		})
	}
</script>
