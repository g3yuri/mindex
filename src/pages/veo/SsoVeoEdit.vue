		...
		<m-loading ref="main">
			<div class="row q-col-gutter-md">
				...
				<div class="col-12">
					...
					<q-input v-if="have_obs" stack-label outlined label="Observacion" v-model="info.observacion" type="textarea" autogrow/>
				</div>
				<div class="col-sm-12 col-xs-4 offset-xs-4 offset-sm-0 t-text-center">
					<q-btn label="Crear" @click="crear" icon="o_add" unelevated color="primary"/>
