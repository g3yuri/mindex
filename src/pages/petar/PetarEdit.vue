	...
	<q-page class="q-pa-md q-gutter-md">
		<m-loading ref="main">
			<div class="row q-col-gutter-md">
				<div class="col-3 col-sm-2 t-font-bold">
					FECHA
				</div>
				...
				<div class="col-12 col-sm-6">
					<q-input stack-label outlined label="Actividad" v-model="info.actividad" />
				</div>
			...
			<div class="t-py-4">
				<div class="row q-col-gutter-md">
					<div :class="`${info.id?'col-xs-6 col-md-3 offset-md-3':'col-12'} t-text-center`">
						<q-btn label="Guardar" @click="guardar" icon="o_save" unelevated color="primary"/>
					</div>
					<div v-if="info.id" class="col-xs-6 col-md-3 t-text-center">
						<q-btn label="Eliminar" @click="eliminar" icon="o_delete" unelevated color="negative"/>
					</div>
				</div>
			</div>
		</m-loading>
...
<script setup>
	...
	info = reactive({
		...
		nivel: '12B',
		labor: 'XC 400',
		supervisor: {value:'75829189', label: '75829189 DANIEL', nombre: 'DANIEL'},
