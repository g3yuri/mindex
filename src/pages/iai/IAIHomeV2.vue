		...
		<div>
			<m-loading ref="main">
				<div v-if="tag=='ultimos'" class="row q-col-gutter-md">
					<div v-for="el in list" class="t-w-full t-flex t-py-2">
						<div class="t-w-2/6 t-pr-1">
							<div class="t-flex t-items-center">
								<div class="t-font-bold t-text-lg t-pr-2">{{el.fecha_corta}}</div>
							</div>
						...
						<div :class="'t-w-4/6 t-rounded-sm t-p-1 t-border-l-4 '+el.riesgo_class">
							...
							<div class="t-w-full">
								...
								<div class="t-text-gray-500 t-text-xs">Daño a: {{el.danio}}</div>
								<div class="t-text-gray-500 t-text-xs">Potencial: {{el.potencial}}</div>
							</div>
...
<script setup>
	...
	list = ref([]),
	main = ref(null),
	months = ref(["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio",
